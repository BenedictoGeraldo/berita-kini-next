...
export default function HomeView() {
  ...
  const terpopuler = getPopularArticles(3);
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between py-6 gap-4">
          ...
          <div className="flex items-center gap-1">
            <button className="px-3 py-1 text-sm text-gray-500 hover:text-blue-600">
              ‹ Previous
            </button>
            <button className="w-8 h-8 flex items-center justify-center rounded bg-blue-600 text-white text-sm font-medium">
              1
            </button>
            <button className="w-8 h-8 flex items-center justify-center rounded bg-white text-gray-500 hover:bg-gray-100 text-sm font-medium">
              2
            </button>
